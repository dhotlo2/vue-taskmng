<template>
	...
	<div :class="'content'">
		...
		<div :class="'demo'">
			...
			<Test v-if="selectedPage.page == 'test'"></Test>
		</div>
	</div>
</div>
</template>
...
import { Simple, SimpleHorizontal, SimpleScroller, Copy, Groups, Nested, LockAxis, DragDelay, DragHandle, DragClass, TransitionDuration, Cards, Form, Table, Test } from './pages';
export default {
	name: "Demo",
	components: {
		Simple, SimpleHorizontal, SimpleScroller, Copy, Groups, Nested, LockAxis, DragDelay, DragHandle, DragClass, TransitionDuration, Cards, Form, Table, Test
	},
  data: function() {
    return {
      isNavOpen: true,
